...
function child_enqueue_styles() {
    wp_enqueue_style('k1-academy-Styles', get_stylesheet_directory_uri() . '/build/index.css', array(), '1.0.0');
    wp_enqueue_script('k1-academy-JS', get_stylesheet_directory_uri() . '/build/index.js', array(), '0.1.0', true);
